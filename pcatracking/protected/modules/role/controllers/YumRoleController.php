...
class YumRoleController extends YumController {
	...
	public function actionCreate() {
		...
		if(isset($_POST['YumRole'])) {
			...
			if (isset($_POST['YumRole']['sectors'])) 
			{
				$model->sectors = $_POST['YumRole']['sectors'];
				$relatedSectors[] = 'sectors';


			}
			if($model->saveWithRelated($relatedSectors)) {
	...
	public function actionUpdate() {
		...
		if(isset($_POST['YumRole'])) {
			...
			if ($model->validate() && $model->saveWithRelated($relatedSectors)) 
