 ...
 */
class SectorUser extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, sector_id', 'required'),
			array('user_id, sector_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('user_id, sector_id', 'safe', 'on'=>'search'),
		);
	}
