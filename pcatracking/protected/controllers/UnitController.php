...
class UnitController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		try {
			...
			foreach ($loaded->unit_cannot_delete_dep as $key => $value) {
			...
			}else
			{
        		...
        		echo 'Unit "'.$loaded->type.'" cannot be deleted due to the following dependecies: '.$error_message;//html for 500 page
